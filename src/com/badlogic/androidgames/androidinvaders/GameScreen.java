...
public class GameScreen extends GLScreen {      
    ...
    public void present(float deltaTime) {
        ...
        if (world.ship.lives == 3){
        	batcher.beginBatch(Assets.background2);
            batcher.drawSprite(240, 160, 480, 320, Assets.backgroundRegion2);
        }
        else if (world.ship.lives == 2){
        	batcher.beginBatch(Assets.background);
            batcher.drawSprite(240, 160, 480, 320, Assets.backgroundRegion);
        }
        else if (world.ship.lives == 1){
        	batcher.beginBatch(Assets.background3);
            batcher.drawSprite(240, 160, 480, 320, Assets.backgroundRegion3);
        }
        else if (world.ship.lives == 0){
        	batcher.beginBatch(Assets.background1);
            batcher.drawSprite(240, 160, 480, 320, Assets.backgroundRegion1);
        }
        batcher.endBatch();
