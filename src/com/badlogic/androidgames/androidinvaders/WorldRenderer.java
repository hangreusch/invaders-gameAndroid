...
public class WorldRenderer {
    ...
    public void render(World world, float deltaTime) {
        ...
        renderShields(world, gl, world.shields);
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (invader.state == Invader.INVADER_DEAD) {
                ...
                gl.glTranslatef(invader.position.x, invader.position.y,
                        invader.position.z);
                gl.glRotatef(invaderAngle*(float)Math.random()*100, 0, 1, 0);
    ...
    private void renderShields(World world, GL10 gl, List<Shield> shields) {
