...
public class Assets {
    ...
    public static void load(GLGame game) {
        ...
        background1 = new Texture(game, "background1.jpg", true);
        backgroundRegion1 = new TextureRegion(background1, 0, 0, 519, 519);
        background2 = new Texture(game, "background2.jpg", true);
        backgroundRegion2 = new TextureRegion(background2, 0, 0, 480, 320);
        background3 = new Texture(game, "background3.jpg", true);
        backgroundRegion3 = new TextureRegion(background3, 0, 0, 480, 320);
        items = new Texture(game, "items.png", true);
        fire = new Texture(game, "fire.png", true);
        ...
        fireRegion = new TextureRegion(fire, 0, 0, 64, 64);
